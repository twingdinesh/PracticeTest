...
public class jmain5 extends AppCompatActivity {
    private jeemainquestionlibrary5 questionlibrary=new jeemainquestionlibrary5();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        count=new CountDownTimer(3*60*60*1000,1000) {
            ...
            public void onFinish() {
                ...
                AlertDialog.Builder builder= new AlertDialog.Builder(jmain5.this);
                builder.setTitle("time out").setMessage("would you like to checck answer?");
                builder.setPositiveButton("yes", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        Intent in=new Intent(jmain5.this,jmainans5.class);
                        startActivity(in);
                    }
                }).setNegativeButton("no", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        Intent in=new Intent(jmain5.this,jeemain.class);
                        startActivity(in);
                    }
                }).setCancelable(false);
    ...
    private void finishtest() {
        Intent intent=new Intent(jmain5.this,jmainprogress5.class);
...
//                Intent in=new Intent(MainActivity.this,answer.class);
                jmain5.this.finish();
                startActivity(new Intent(jmain5.this,jmainans5.class));
            }
