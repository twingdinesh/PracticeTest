...
public class jadvprogress3 extends AppCompatActivity {
    javaadvquestionlibrary3 questionlibrary=new javaadvquestionlibrary3();
    jadv3 mainActivity=new jadv3();
    jadvalert3 alert=new jadvalert3();
    TextView report;
    public String store;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_jadvprogress3);
    ...
    public void result(View view) {
        ...
        Intent in=new Intent(jadvprogress3.this,jadvresult3.class);
        in.putExtra("youranswer",youranswer);
        jadvprogress3.this.finish();
        startActivity(in);
    }
