...
//you can fill jeeAdavanced modal question 3
public class javaadvquestionlibrary3 {
    //here you can change the questions in order
    private String mQuestions[]={
            "jee adv  3 The magnetic potential energy stored iin certain induction is 25MJ.when the current in the inductors is 60Ma.this inductors is of inductance",
