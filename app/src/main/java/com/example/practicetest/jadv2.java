...
public class jadv2 extends AppCompatActivity {
    private javaadvquestionlibrary2 questionlibrary=new javaadvquestionlibrary2();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_jadv2);
        ...
        count=new CountDownTimer(3*60*60*1000,1000) {
            ...
            public void onFinish() {
                ...
                AlertDialog.Builder builder= new AlertDialog.Builder(jadv2.this);
                builder.setTitle("time out").setMessage("would you like to checck answer?");
                builder.setPositiveButton("yes", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        Intent in=new Intent(jadv2.this,jadvans2.class);
                        startActivity(in);
                    }
                }).setNegativeButton("no", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        Intent in=new Intent(jadv2.this,jeeAdvanced.class);
                        startActivity(in);
                    }
                }).setCancelable(false);
    ...
    private void finishtest() {
        Intent intent=new Intent(jadv2.this,jadvprogress2.class);
...
//                Intent in=new Intent(MainActivity.this,answer.class);
                jadv2.this.finish();
                startActivity(new Intent(jadv2.this,jadvans2.class));
            }
