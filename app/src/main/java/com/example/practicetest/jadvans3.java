...
public class jadvans3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_jadvans3);
        ...
        ansprev.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(qno==0)
                {
                    Toast.makeText(jadvans3.this,"first question",Toast.LENGTH_SHORT).show();
                    nextans.setVisibility(View.VISIBLE);
                    ansprev.setVisibility(View.INVISIBLE);
    ...
    {
        Intent in=new Intent(jadvans3.this,jeeAdvanced.class);
        jadvans3.this.finish();
        startActivity(in);
    }
    }
