...
public class jeemainquestionlibrary4 {
    ...
    private String mQuestions[]={
            "jee main question 4 The magnetic potential energy stored iin certain induction is 25MJ.when the current in the inductors is 60Ma.this inductors is of inductance",
