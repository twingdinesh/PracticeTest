...
public class jmain3 extends AppCompatActivity {
    private jeemainquestionlibrary3 questionlibrary=new jeemainquestionlibrary3();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_jmain3);
        ...
        count=new CountDownTimer(3*60*60*1000,1000) {
            ...
            public void onFinish() {
                ...
                AlertDialog.Builder builder= new AlertDialog.Builder(jmain3.this);
                builder.setTitle("time out").setMessage("would you like to checck answer?");
                builder.setPositiveButton("yes", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        Intent in=new Intent(jmain3.this,jmainans3.class);
                        startActivity(in);
                    }
                }).setNegativeButton("no", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        Intent in=new Intent(jmain3.this,jeemain.class);
                        startActivity(in);
                    }
                }).setCancelable(false);
    ...
    private void finishtest() {
        Intent intent=new Intent(jmain3.this,jmainprogress3.class);
...
//                Intent in=new Intent(MainActivity.this,answer.class);
                jmain3.this.finish();
                startActivity(new Intent(jmain3.this,jmainans3.class));
            }
