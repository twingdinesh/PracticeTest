...
public class neetans3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_neetans3);
        ...
        ansprev.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(qno==0)
                {
                    Toast.makeText(neetans3.this,"first question",Toast.LENGTH_SHORT).show();
                    nextans.setVisibility(View.VISIBLE);
                    ansprev.setVisibility(View.INVISIBLE);
    ...
    {
        Intent in=new Intent(neetans3.this,NeetTest.class);
        neetans3.this.finish();
        startActivity(in);
    }
