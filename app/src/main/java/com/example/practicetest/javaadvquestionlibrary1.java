...
//you can fill jeeAdavanced modal question 1
public class javaadvquestionlibrary1 {
    //here you can change the questions in order
    private String mQuestions[]={
            "jee adv 1 The magnetic potential energy stored iin certain induction is 25MJ.when the current in the inductors is 60Ma.this inductors is of inductance",
