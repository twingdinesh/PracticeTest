...
public class jadv3 extends AppCompatActivity {
    private javaadvquestionlibrary3 questionlibrary=new javaadvquestionlibrary3();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_jadv3);
        ...
        count=new CountDownTimer(3*60*60*1000,1000) {
            ...
            public void onFinish() {
                ...
                AlertDialog.Builder builder= new AlertDialog.Builder(jadv3.this);
                builder.setTitle("time out").setMessage("would you like to checck answer?");
                builder.setPositiveButton("yes", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        Intent in=new Intent(jadv3.this,jadvans3.class);
                        startActivity(in);
                    }
                }).setNegativeButton("no", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        Intent in=new Intent(jadv3.this,jeeAdvanced.class);
                        startActivity(in);
                    }
                }).setCancelable(false);
    ...
    private void finishtest() {
        Intent intent=new Intent(jadv3.this,jadvprogress3.class);
...
//                Intent in=new Intent(MainActivity.this,answer.class);
                jadv3.this.finish();
                startActivity(new Intent(jadv3.this,jadvans3.class));
            }
