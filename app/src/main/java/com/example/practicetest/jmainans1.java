...
public class jmainans1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_jmainans1);
        ...
        ansprev.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(qno==0)
                {
                    Toast.makeText(jmainans1.this,"first question",Toast.LENGTH_SHORT).show();
                    nextans.setVisibility(View.VISIBLE);
                    ansprev.setVisibility(View.INVISIBLE);
    ...
    public void updatesheet()
    {
        if(qno!=questionlibrary.length) {
            ...
            imgques.setImageResource(questionlibrary.getQuestions(qno));
    ...
    {
        Intent in=new Intent(jmainans1.this,jeemain.class);
        jmainans1.this.finish();
        startActivity(in);
    }
    }
