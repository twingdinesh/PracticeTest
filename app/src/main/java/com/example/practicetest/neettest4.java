...
public class neettest4 extends AppCompatActivity {
    private neetquestionlibrary4 questionlibrary=new neetquestionlibrary4();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_neettest4);
...
//        bookmarkimage=(ImageView)findViewById(R.id.imageView);
        ...
        count=new CountDownTimer(3*60*60*1000,1000) {
            ...
            public void onFinish() {
                ...
                AlertDialog.Builder builder= new AlertDialog.Builder(neettest4.this);
                builder.setTitle("time out").setMessage("would you like to checck answer?");
                builder.setPositiveButton("yes", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        Intent in=new Intent(neettest4.this,neetans4.class);
                        startActivity(in);
                    }
                }).setNegativeButton("no", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        Intent in=new Intent(neettest4.this,NeetTest.class);
                        startActivity(in);
                    }
                }).setCancelable(false);
    ...
    private void finishtest() {
        Intent intent=new Intent(neettest4.this,neet4progress.class);
        Bundle bundle=new Bundle();
        bundle.putIntArray("youranswer",ans);
        intent.putExtras(bundle);
        neettest4.this.finish();
...
//                Intent in=new Intent(MainActivity.this,answer.class);
                neettest4.this.finish();
                startActivity(new Intent(neettest4.this,neetans4.class));
            }
