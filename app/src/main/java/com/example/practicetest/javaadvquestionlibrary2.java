...
//you can fill jeeAdavanced modal question 2
public class javaadvquestionlibrary2 {
    //here you can change the questions in order
    private String mQuestions[]={
            "jee adv 2 The magnetic potential energy stored iin certain induction is 25MJ.when the current in the inductors is 60Ma.this inductors is of inductance",
