...
public class neetest2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        count=new CountDownTimer(3*60*60*1000,1000) {
            ...
            public void onFinish() {
                ...
                AlertDialog.Builder builder= new AlertDialog.Builder(neetest2.this);
                builder.setTitle("time out").setMessage("would you like to checck answer?");
                builder.setPositiveButton("yes", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        Intent in=new Intent(neetest2.this,neetans2.class);
                        startActivity(in);
                    }
                }).setNegativeButton("no", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        Intent in=new Intent(neetest2.this,NeetTest.class);
                        startActivity(in);
                    }
                }).setCancelable(false);
    ...
    private void finishtest() {
        Intent intent=new Intent(neetest2.this,neet2progress.class);
        Bundle bundle=new Bundle();
        bundle.putIntArray("youranswer",ans);
        intent.putExtras(bundle);
        neetest2.this.finish();
...
//                Intent in=new Intent(MainActivity.this,answer.class);
                neetest2.this.finish();
                startActivity(new Intent(neetest2.this,neetans2.class));
            }
