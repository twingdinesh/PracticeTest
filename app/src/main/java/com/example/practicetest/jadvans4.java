...
public class jadvans4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_jadvans4);
        ...
        ansprev.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(qno==0)
                {
                    Toast.makeText(jadvans4.this,"first question",Toast.LENGTH_SHORT).show();
                    nextans.setVisibility(View.VISIBLE);
                    ansprev.setVisibility(View.INVISIBLE);
    ...
    {
        Intent in=new Intent(jadvans4.this,jeeAdvanced.class);
        jadvans4.this.finish();
        startActivity(in);
    }
