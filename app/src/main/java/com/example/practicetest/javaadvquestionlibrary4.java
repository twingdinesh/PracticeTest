...
//you can fill jeeAdavanced modal question 4
public class javaadvquestionlibrary4 {
    //here you can change the questions in order
    private String mQuestions[]={
            "jee adv  4 The magnetic potential energy stored iin certain induction is 25MJ.when the current in the inductors is 60Ma.this inductors is of inductance",
