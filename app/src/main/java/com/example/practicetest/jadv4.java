...
public class jadv4 extends AppCompatActivity {
    private javaadvquestionlibrary4 questionlibrary=new javaadvquestionlibrary4();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_jadv4);
        ...
        count=new CountDownTimer(3*60*60*1000,1000) {
            ...
            public void onFinish() {
                ...
                AlertDialog.Builder builder= new AlertDialog.Builder(jadv4.this);
                builder.setTitle("time out").setMessage("would you like to checck answer?");
                builder.setPositiveButton("yes", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        Intent in=new Intent(jadv4.this,jadvans4.class);
                        startActivity(in);
                    }
                }).setNegativeButton("no", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        Intent in=new Intent(jadv4.this,jeeAdvanced.class);
                        startActivity(in);
                    }
                }).setCancelable(false);
    ...
    private void finishtest() {
        Intent intent=new Intent(jadv4.this,jadvprogress4.class);
...
//                Intent in=new Intent(MainActivity.this,answer.class);
                jadv4.this.finish();
                startActivity(new Intent(jadv4.this,jadvans4.class));
            }
