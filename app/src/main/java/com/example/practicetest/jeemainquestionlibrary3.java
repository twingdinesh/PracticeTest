...
public class jeemainquestionlibrary3 {
    ...
    private String mQuestions[]={
            "jee main question 3 The magnetic potential energy stored iin certain induction is 25MJ.when the current in the inductors is 60Ma.this inductors is of inductance",
