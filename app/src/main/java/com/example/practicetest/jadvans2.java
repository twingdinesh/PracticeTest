...
public class jadvans2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_jadvans2);
        ...
        ansprev.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(qno==0)
                {
                    Toast.makeText(jadvans2.this,"first question",Toast.LENGTH_SHORT).show();
                    nextans.setVisibility(View.VISIBLE);
                    ansprev.setVisibility(View.INVISIBLE);
    ...
    {
        Intent in=new Intent(jadvans2.this,jeeAdvanced.class);
        jadvans2.this.finish();
        startActivity(in);
    }
    }
