...
//you can fill jeemain modal test 4
public class neetquestionlibrary4 {
    //here you can change the questions in order
    private String mQuestions[]={
            "question 3 The magnetic potential energy stored iin certain induction is 25MJ.when the current in the inductors is 60Ma.this inductors is of inductance",
