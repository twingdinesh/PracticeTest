...
public class jadv5 extends AppCompatActivity {
    private javaadvquestionlibrary5 questionlibrary=new javaadvquestionlibrary5();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_jadv5);
        ...
        count=new CountDownTimer(3*60*60*1000,1000) {
            ...
            public void onFinish() {
                ...
                AlertDialog.Builder builder= new AlertDialog.Builder(jadv5.this);
                builder.setTitle("time out").setMessage("would you like to checck answer?");
                builder.setPositiveButton("yes", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        Intent in=new Intent(jadv5.this,jadvans5.class);
                        startActivity(in);
                    }
                }).setNegativeButton("no", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        Intent in=new Intent(jadv5.this,jeeAdvanced.class);
                        startActivity(in);
                    }
                }).setCancelable(false);
    ...
    private void finishtest() {
        Intent intent=new Intent(jadv5.this,jadvprogress5.class);
...
//                Intent in=new Intent(MainActivity.this,answer.class);
                jadv5.this.finish();
                startActivity(new Intent(jadv5.this,jadvans5.class));
            }
